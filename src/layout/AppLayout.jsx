    ...
    <div className="layout">
      <aside className="sidebar">
        ...
        <nav className="grid" style={{ gap: 8 }}>
          ...
          <NavLink to="/restaurant-categories" className={({ isActive }) => isActive ? 'active' : ''}>Danh mục nhà hàng</NavLink>
          <NavLink to="/product-categories" className={({ isActive }) => isActive ? 'active' : ''}>Loại đồ ăn</NavLink>
